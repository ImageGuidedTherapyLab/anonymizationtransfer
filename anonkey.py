...
select pt.UID,pt.PatientID,st.StudyInstanceUID,st.StudyDate,se.SeriesInstanceUID,im.SOPInstanceUID, replace(im.Filename, '/home/fuentes/cmdanon/dicom/','') as phiUID
